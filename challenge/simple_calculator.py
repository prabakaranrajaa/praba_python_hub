...
# math operations, add, subtract, divide and multiply. The calculator should 
# take input from users. The calculator should be able to handle ZeroDivisionError, 
# NameError, and ValueError.

import operator
def calculator(): 
    try:
        num1 = int(input("Enter number: ")) # asking the user to pick an operator
